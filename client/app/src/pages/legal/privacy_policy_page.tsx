...
const sections = [
  ...
  },
  {
    ...
    body: 'Hatrick is built with public football profiles. Your username, prediction rank, public ranking statistics, follower count, following count, followers list, and following list may be visible to other signed in users. Your full name is shown publicly only if you choose to enable the public name setting in your profile. Email address, session records, authentication details, and security information are not shown on public profiles.',
  },
  {
