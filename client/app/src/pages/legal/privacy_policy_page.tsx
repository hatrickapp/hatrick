...
const sections = [
  ...
  },
  {
    ...
    body: 'Hatrick is built with public football profiles. Your username, full name, prediction rank, public ranking statistics, follower count, following count, followers list, and following list may be visible to other signed in users. Email address, session records, authentication details, and security information are not shown on public profiles.',
  },
  {
