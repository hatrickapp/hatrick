...
const sections = [
  ...
  },
  {
    ...
    body: 'Hatrick usernames, full names, ranking statistics, prediction statistics, follower counts, following counts, followers lists, and following lists are public to signed in users.',
  },
  {
