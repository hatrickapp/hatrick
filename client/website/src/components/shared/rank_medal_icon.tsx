...
export function HatrickHeroMedalIcon({ className, ...props }: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 32 32" aria-hidden="true" className={className} fill="none" {...props}>
      ...
      <path d="M16 16.95L17.05 19.1L19.42 19.44L17.71 21.11L18.11 23.47L16 22.35L13.89 23.47L14.29 21.11L12.58 19.44L14.95 19.1L16 16.95Z" fill="#B91C1C" />
    </svg>
  )
}
...
export function BronzeRankShieldIcon(props: RankIconProps) {
  return <RankShieldIcon {...props} tier="bronze" />
}

export function SilverRankShieldIcon(props: RankIconProps) {
  return <RankShieldIcon {...props} tier="silver" />
}

export function GoldRankShieldIcon(props: RankIconProps) {
  return <RankShieldIcon {...props} tier="gold" />
}
