...
const sections = [
  ...
  },
  {
    ...
    body: 'Hatrick Plus is purchased only through Apple in app purchases on iOS or Google Play in app purchases on Android. The Hatrick website does not sell subscriptions directly, does not collect card details, and does not run its own web checkout.',
  },
  {
    title: 'Does Hatrick use a web payment processor?',
    body: 'No. Hatrick does not use cards or web payment processors for Plus subscriptions on this website. We do not process card numbers, card security codes, billing addresses, or web checkout payments for Plus. Subscription purchase, renewal, cancellation, refund handling, and payment method management happen through Apple or Google according to their store rules.',
  },
  {
    title: 'How does RevenueCat support subscriptions?',
    body: 'Hatrick uses RevenueCat to help manage in app purchase subscription status across Apple App Store and Google Play. RevenueCat helps us understand whether an account has an active Plus entitlement, restore purchases where supported, and keep subscription access in sync with the app. RevenueCat does not mean Hatrick is processing card payments on the website.',
  },
  {
      ...
      <main className="mx-auto flex w-full max-w-4xl flex-col gap-8 px-4 py-10 sm:px-6 lg:px-8">
        <article className="space-y-10">
          <header className="space-y-5 border-b border-border/40 pb-8">
            <div>
              <p className="text-[11px] font-medium uppercase tracking-widest text-muted-foreground/60">Pricing Terms</p>
              <h1 className="mt-3 max-w-3xl text-xl font-medium tracking-tight">
                Hatrick pricing terms and subscription billing
              </h1>
