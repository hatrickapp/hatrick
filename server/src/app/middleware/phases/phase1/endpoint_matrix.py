...
ROUTE_MATRIX: list[RouteEntry] = [
    ...
    # --- Billing ---
    ("GET", "/v1/billing/revenuecat/status", EndpointConfig(access="authenticated", rate_by="user", rate_hits=30, rate_window=60, max_body_bytes=0)),
    ...
    # --- Sports ---
    ("GET", "/v1/sports/competitions", EndpointConfig(access="authenticated", rate_by="user", rate_hits=60, rate_window=60, max_body_bytes=0, csp=True)),
    ("GET", "/v1/sports/matches", EndpointConfig(access="authenticated", rate_by="user", rate_hits=120, rate_window=60, max_body_bytes=0, csp=True)),
    ("GET", "/v1/sports/matches/{match_id}", EndpointConfig(access="authenticated", rate_by="user", rate_hits=120, rate_window=60, max_body_bytes=0, csp=True)),
    ...
    ("GET", "/v1/predictions", EndpointConfig(access="authenticated", rate_by="user", rate_hits=60, rate_window=60, max_body_bytes=0, csp=True)),

    # --- Leagues ---
    ("GET", "/v1/leagues", EndpointConfig(access="authenticated", rate_by="user", rate_hits=60, rate_window=60, max_body_bytes=0, csp=True)),
    ("GET", "/v1/leagues/config", EndpointConfig(access="authenticated", rate_by="user", rate_hits=60, rate_window=60, max_body_bytes=0, csp=True)),
    ...
    ("GET", "/v1/leagues/invitations", EndpointConfig(access="authenticated", rate_by="user", rate_hits=60, rate_window=60, max_body_bytes=0, csp=True)),
    ...
    ("GET", "/v1/leagues/{league_id}", EndpointConfig(access="authenticated", rate_by="user", rate_hits=120, rate_window=60, max_body_bytes=0, csp=True)),
    ("GET", "/v1/leagues/{league_id}/standings", EndpointConfig(access="authenticated", rate_by="user", rate_hits=120, rate_window=60, max_body_bytes=0, csp=True)),
    ...
    # --- Users ---
    ("GET", "/v1/users/search", EndpointConfig(access="authenticated", rate_by="user", rate_hits=120, rate_window=60, max_body_bytes=0, csp=True)),
    ...
    ("GET", "/v1/users/{username}/followers", EndpointConfig(access="authenticated", rate_by="user", rate_hits=120, rate_window=60, max_body_bytes=0, csp=True)),
    ("GET", "/v1/users/{username}/following", EndpointConfig(access="authenticated", rate_by="user", rate_hits=120, rate_window=60, max_body_bytes=0, csp=True)),
    ("GET", "/v1/users/{username}", EndpointConfig(access="authenticated", rate_by="user", rate_hits=120, rate_window=60, max_body_bytes=0, csp=True)),
]
