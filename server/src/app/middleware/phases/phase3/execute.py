...
async def execute_phase_3(ctx: RequestContext, lua_manager: LuaScriptManager, request: Request) -> RequestContext:
    ...
    result = await check_and_set_idempotency(lua_manager, ctx.idempotency_key, payload_hash)
